...
class SixteenBitCows(data.Dataset):
	# Class constructor
	def __init__(	self,
					fold,
					fold_file,
		...
		self.__root = "/user/home/xm20246/scratch/datasets/SixteenBitCowsLeaveSequenceOut"
	...
	def printStats(self):
		print("Loaded the RGBDCows202066 dataset_____________________________")
